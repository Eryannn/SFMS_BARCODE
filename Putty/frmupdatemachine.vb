...
Public Class frmupdatemachine
    ...
    Private Sub frmupdatemachine_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtopernum_TextChanged(sender As Object, e As EventArgs) Handles txtopernum.TextChanged
        Try
            ...
            If readitems.HasRows Then
                While readitems.Read()
                    ...
                    lblqtymoved.Text = readitems("qty_moved").ToString
        ...
        'Try
        '    con1.Open()
        '    Dim cmd As New SqlCommand("select reason_class, reason_code, description, reason_code + ' / ' + description as codeanddesc from reason where reason_code = @code", con1)
    ...
    Private Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        ...
        Try
            ...
            cmdupdatesfms.Parameters.AddWithValue("@qtymoved", CInt(lblqtymoved.Text))
    ...
    Private Sub btnpost_Click(sender As Object, e As EventArgs) Handles btnpost.Click
        Dim cmdreadsfms As SqlCommand = New SqlCommand("Select * from sfms_jobtran where job=@job And suffix=@suffix And oper_num=@opernum And emp_num=@empnum And Trans_type = 'C' AND start_time = @starttime and end_time=@endtime AND shift=@shift and CONVERT(VARCHAR, trans_date, 120) LIKE @transdate + '%'", con)
    ...
    Private Sub cmbreasoncode_TextChanged(sender As Object, e As EventArgs) Handles cmbreasoncode.TextChanged
